...
class LoadDeveloperProjectsCommandTest {
    ...
    public void testConstructorValidData() {
        LoadDeveloperProjectsCommand command = new LoadDeveloperProjectsCommand(validDeveloperId);
    ...
    public void testConstructorEmptyDeveloperId() {
        assertThrows(ConstraintViolationException.class,
                () -> new LoadDeveloperProjectsCommand(null));
    }
}